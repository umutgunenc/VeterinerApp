...
namespace VeterinerApp.Migrations
{
    ...
    [Migration("20240909115734_migration5")]
            ...
            modelBuilder.Entity("VeterinerApp.Models.Entity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "fcb75942-fa56-4afb-a99b-e02616ec24b0",
                            Name = "ADMİN",
            ...
            modelBuilder.Entity("VeterinerApp.Models.Entity.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CalisiyorMu = true,
                            ConcurrencyStamp = "30a5f66a-de46-4882-b91e-688ae205afe0",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHj7HBuKw56vELbqezziUlkq7cdK4WlMckOK7dAxH+iWBcC5VTq9dm+esPJEQtu0pg==",
                            PhoneNumber = "05300000000",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8484cc53-78e6-498d-b04e-92c7dc511177",
                            SifreGecerlilikTarihi = new DateTime(3023, 9, 9, 14, 57, 32, 871, DateTimeKind.Local).AddTicks(2246),
                            SifreOlusturmaTarihi = new DateTime(2024, 9, 9, 14, 57, 32, 869, DateTimeKind.Local).AddTicks(5257),
                            TermOfUse = true,
