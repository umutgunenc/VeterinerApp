    ...
    public class AdminController : Controller
    {
        ...
        public IActionResult CalisanEkle(InsanEkleViewModel model)
        {
            ...
            if (_veterinerDbContext.SaveChanges() > 0)
            {
                ...
                TempData["CalısanEklendi"] = $"{model.InsanAdi.ToUpper()} {model.InsanSoyadi.ToUpper()} isimli calisan {rolAdi.First().ToUpper()} görevi ile sisteme kaydedildi. Kullanıcı adı ve şifresi {model.InsanMail.ToUpper()} adresine gönderildi.";
